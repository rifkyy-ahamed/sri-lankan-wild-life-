...
// fetch the JSON data
fetch('willpathu.json')
    .then(response => response.json())
    .then(data => {

        willpathuData.numberOneh1 = data.numberOneh1;
        willpathuData.numberOnep = data.numberOnep;
        willpathuData.numberOneh2 = data.numberOneh2;
        willpathuData.numberOneh3 = data.numberOneh3;
        willpathuData.numberOnep1 = data.numberOnep1;
        willpathuData.numberOneh4 = data.numberOneh4;
        willpathuData.numberOnep2 = data.numberOnep2;
        willpathuData.numberOneli1 = data.numberOneli1;
        willpathuData.numberOneli2 = data.numberOneli2;
        willpathuData.numberOneh5 = data.numberOneh5;
        willpathuData.numberOnep3 = data.numberOnep3;
        willpathuData.numberOneli3 = data.numberOneli3;
        willpathuData.numberOneli4 = data.numberOneli4;
        willpathuData.numberOneli5 = data.numberOneli5;

        localStorage.setItem("willpathuData",JSON.stringify(data));
...
function saveChanges() {
    ...
    var paragraph6 = document.getElementById("Sevenp4").value;
    var paragraph7 = document.getElementById("Li3").value;
    ...
    document.querySelector(".sevenp4").innerText = paragraph6;
    document.querySelector(".li3").innerText = paragraph7;
